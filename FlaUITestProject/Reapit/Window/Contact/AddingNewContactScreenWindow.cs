...
namespace FlaUIPoC.AgencyCloud.Window.Contact
{
    public class AddingNewContactScreenWindow
   {
      ...
      public AddingNewContactScreenWindow(FlaUI.Core.AutomationElements.Window window)
      {
